        ...
        <main>
            <div class="mainbackground">
                ...
                <div class="review">
                    ...
                    $sql =  "SELECT * FROM autor, genre, buch, review WHERE review.BUCHID = buch.BUCHID AND buch.AUTORID = autor.AUTORID AND buch.GENREID = genre.GENREID ORDER BY VORNAME ASC";
